...
*实验环境：pi 0.86.1 · glm-5.3-flash（PackyCode 通道）· jev-1.13.0 · Node 24 · Windows。数据来自本仓库测试与 `~/.pi/jev-router/decisions.jsonl` 真实运行记录；图表由 `python scripts/charts.py` 从转写数据生成。*
